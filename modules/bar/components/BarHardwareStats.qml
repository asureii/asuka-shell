...
Rectangle {
    ...
    color: root.isPopoutOpen ? root.primary : (statsMouse.containsMouse ? Qt.rgba(root.primary.r, root.primary.g, root.primary.b, 0.16) : Qt.rgba(root.primary.r, root.primary.g, root.primary.b, 0.08))
    border.width: 1
